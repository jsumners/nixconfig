 ...
 *
 * @namespace {object} kvmesh
 */
const kvmeshProto = Object.create({}, {
  loaders: {
    value: {
      '.js': require,
      '.json': require,
 ...
 *
 * @returns {object} The current *kvmesh* instance.
 ...
 * @method addLoader
 */
kvmeshProto.addLoader = function addLoader (ext, method) {
 ...
 * a path, separated by the `kvmesh.delim` value. For example, `foo.bar` to
 ...
 * @method get
 */
kvmeshProto.get = function getValue (key) {
 ...
 * @see {@link kvmesh.get} for details on pathing.
 *
 * @returns {kvmesh} The current kvmesh instance.
 * @throws {Error} When a supplied path cannot be reached.
 *
 * @memberof kvmesh
 * @method set
 */
kvmeshProto.set = function setValue (key, value) {
